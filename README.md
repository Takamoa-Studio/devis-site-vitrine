...
- **Volume par tâche** : `getTaskVolume()` associe une clé de volume à chaque tâche (pages, options, blog, etc.) pour multiplier les heures de base. La recette QA utilise la clé `qaWorkload`, calculée à partir du total de pages (home comprise) et des fonctionnalités activées (services/réalisations, blog/import, logo/formation, chatbot, hébergement/domaine). 【F:index.html†L2197-L2229】【F:index.html†L3292-L3313】
